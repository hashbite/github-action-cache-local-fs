...
function filterCacheFiles(filenameMatchers, cacheFiles) {
    const potentialCaches = [];
...
function locateCacheFile(filenameMatchers, cacheFiles) {
    const { key, potentialCaches } = filterCacheFiles(filenameMatchers, cacheFiles);
...
function restoreCache(paths, primaryKey, restoreKeys) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const cacheFiles = yield fast_glob_1.default(patterns, {
            cwd: cacheDir,
            objectMode: true,
            onlyFiles: true,
            stats: true,
        ...
        const cachePath = path_1.join(cacheDir, cacheFile.path);
